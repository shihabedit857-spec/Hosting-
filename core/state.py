...
class BotState:
    def __init__(self):
        ...
        # Panel emoji mode: based on the ACCOUNT THAT CREATED/OWNS the bot
        # True  → Premium Panel (custom emoji icons)
        # False → Free Panel (normal unicode emoji)
        self.panel_is_premium = False
